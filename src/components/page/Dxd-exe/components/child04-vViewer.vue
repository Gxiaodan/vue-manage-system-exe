<template>
  <div>
    ...
    =============================================================
   <viewer>
      <img  :src="imgTest.thumbnail" :data-source="source">
    </viewer>

    <div v-viewer="optionTest">
      <img  :src="imgTest.thumbnail" :data-source="imgTest.source">
    </div>
    <div>
...
name: "ExeChild04",
  data () {
    return {
      ...
      imgTest: {
        thumbnail: 'http://172.20.32.32:9080/face/3.jpg',
        source: 'http://172.20.32.32:9080/face/3.jpg',
      },
      optionTest: {
        inline: false,
        button: true,
